        ...
        try {
            ...
            area.innerHTML = `
                <div class="animate-fade-in px-2">
                    ...
                    <div class="bg-white border border-red-200 rounded-3xl p-6 md:p-10 shadow-sm border-t-8 border-t-red-800">
                        <h2 class="text-2xl font-bold text-orange-900 mb-6 border-b border-red-100 pb-4 italic">
                            ${song.title}
                        </h2>
